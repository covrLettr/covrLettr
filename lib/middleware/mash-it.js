...
const populateSentences = (sentencesArr, userAnswers) => {
    ...
    const body1PS1Final = wholeArray[1][0][randomIndex(wholeArray[1][0])];
    const body1PS2Final = wholeArray[1][1][randomIndex(wholeArray[1][1])];
    const body1PS3Final = wholeArray[1][2][randomIndex(wholeArray[1][2])];
    const body1PS4Final = wholeArray[1][3][randomIndex(wholeArray[1][3])];

    const body2PS1Final = wholeArray[2][0][randomIndex(wholeArray[2][0])];
    const body2PS2Final = wholeArray[2][1][randomIndex(wholeArray[2][1])];
    const body2PS3Final = wholeArray[2][2][randomIndex(wholeArray[2][2])];
    const body2PS4Final = wholeArray[2][3][randomIndex(wholeArray[2][3])];
