...
const populateSentences = (sentencesArr, userAnswers) => {
    ...
    console.log(groupBy(body1P, 'position'));
    console.log(groupBy(body2P, 'position'));
    
        
    // const pos0Arrs = (paragraphArr) => {
    //     paragraphArr.reduce((acc, curr) => {
    //         if(curr.position === 0){
    //             acc.push(curr);
    //         }
    //         return acc;
