...
const makeCoverLetter = (sentencesArr, userAnswers) => {
    ...
    //const randomize = Math.floor(Math.random() * coverLetterArr.length);
    // console.log(coverLetterArr);
    Array.prototype.random = function(length) {
        return this[Math.floor((Math.random() * length))];
    };
    //const chosenOne = coverLetterArr.sort(function() {return 0.5 - Math.random();})[0];
    // console.log(chosenOne);
    // return chosenOne; 
    // return finalCoverLetter; 
    return coverLetterArr[0];
    
};

console.log(makeCoverLetter(sentences, answers));
makeCoverLetter(sentences, answers);

module.exports = makeCoverLetter;
