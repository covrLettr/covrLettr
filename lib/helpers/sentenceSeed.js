const sentences = [{
    ...
    paragraph: 'body2',
    position: 1,
    text: 'My past work experience as a --pastExperience-- has prepared me well for the tech industry.  My --skillsJobDescription1-- and --skillsJobDescription2-- have been continuously strengthened with my everlasting grit.'
}, {
    paragraph: 'body2',
    position: 1,
    ...
    paragraph: 'conclusion',
    position: 1,
    text: ' believe I am the best person for this position and would love to meet you and share what I can bring to your company.'
}, {
    paragraph: 'conclusion',
    position: 1,
