const sentences = [{
    ...
    paragraph: 'intro',
    position: 0,
    text: 'When I was growing up, all I wanted to be was one of those people who pretend to be statues on the street. Thankfully, my career goals have become a little more aspirational over the years, but I love to --passion1-- and --passion2-- —passions that make me the perfect --positionTitle--.'
}, {
    paragraph: 'intro',
    position: 0,
    ...
    position: 1,
    //bn
    text: 'I value --value1--, --value12--, and --value3-- because --lifeExperienceRelatedValues--.'
}, {
    paragraph: 'body1',
    position: 2,
    ...
    paragraph: 'body1',
    position: 2,
    text: 'This company helps --companyCustomers--, which is important to me because --whyCustomerMatters--.'
}, {
    paragraph: 'body1',
    position: 3,
