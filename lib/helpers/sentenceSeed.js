const sentences = [{
    ...
    paragraph: 'intro',
    position: 0,
    text: 'When I was growing up, all I wanted to be was one of those people who pretend to be statues on the street. Thankfully, my career goals have become a little more aspirational over the years, but I love to --passion1-- and --passion2--, --passion3-- that make me the perfect --positionTitle--.'
}, {
    paragraph: 'intro',
    position: 0,
